...
if has("nvim")
  ...
  hi @string.special.symbol guifg=#d0dfee
  ...
  hi @type                  guifg=#5f81a5
  hi @type.builtin          guifg=#5f81a5
  hi @type.definition       guifg=#5f81a5
  hi @namespace             guifg=#5f81a5
  hi @symbol                guifg=#d0dfee
  " Tag (HTML/XML)
  hi @tag                   guifg=#5f8787
  hi @tag.attribute         guifg=#5f81a5
