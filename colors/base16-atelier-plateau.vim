...
if has("nvim")
  " Comment
  hi @comment               guifg=#655d5d gui=italic
  " Keyword — matches Keyword (0E), Conditional (0E), Repeat (0A), Exception (08)
  hi @keyword               guifg=#ca4949
  hi @keyword.function      guifg=#ca4949
  hi @keyword.operator      guifg=#8464c4
  hi @keyword.return        guifg=#8464c4
  hi @conditional           guifg=#ca4949
  hi @repeat                guifg=#a06e3b
  hi @exception             guifg=#ca4949
  hi @include               guifg=#7272ca
  " String — matches String (0B), SpecialChar (0F), Special (0C)
  hi @string                guifg=#4b8b8b
  hi @string.escape         guifg=#5485b6
  hi @string.regex          guifg=#5485b6
  hi @string.regexp         guifg=#5485b6
  hi @string.special        guifg=#5485b6
  hi @string.special.symbol guifg=#7272ca
  hi @character             guifg=#ca4949
  " Constant / Number — matches Constant (09), Number (09), Boolean (09)
  hi @number                guifg=#b45a3c
  hi @boolean               guifg=#b45a3c
  hi @float                 guifg=#b45a3c
  hi @constant              guifg=#b45a3c
  hi @constant.builtin      guifg=#b45a3c
  hi @constant.macro        guifg=#ca4949
  " Function / Method — matches Function (0D); calls same as definitions
  hi @function              guifg=#8464c4
  hi @function.builtin      guifg=#8464c4
  hi @function.call         guifg=#8464c4
  hi @function.macro        guifg=#8464c4
  hi @method                guifg=#8464c4
  hi @method.call           guifg=#8464c4
  hi @constructor           guifg=#8464c4
  " Variable / Parameter
  hi @parameter             guifg=#8a8585
  hi @variable              guifg=#8a8585
  hi @variable.builtin      guifg=#b45a3c
  hi @field                 guifg=#8a8585
  hi @property              guifg=#8a8585
  ...
  hi @symbol                guifg=#4b8b8b
  " Tag (HTML/XML)
  hi @tag                   guifg=#ca4949
  hi @tag.attribute         guifg=#a06e3b
  hi @tag.delimiter         guifg=#8a8585
  " Punctuation
  hi @punctuation.bracket   guifg=#8a8585
  hi @punctuation.delimiter guifg=#8a8585
  hi @punctuation.special   guifg=#8a8585
  " Markup
  hi @text.literal          guifg=#4b8b8b
  hi @text.uri              guifg=#ca4949 gui=underline
  hi @text.reference        guifg=#7272ca
  hi @text.strong           guifg=#8a8585 gui=bold
  hi @text.emphasis         guifg=#8a8585 gui=italic
endif
