...
if has("nvim")
  " Comment
  hi @comment               guifg=#809980 gui=italic
  ...
  " Variable / Parameter
  hi @parameter             guifg=#5e6e5e
  hi @variable              guifg=#5e6e5e
  hi @variable.builtin      guifg=#87711d
  hi @field                 guifg=#5e6e5e
  hi @property              guifg=#5e6e5e
  ...
  hi @tag.delimiter         guifg=#5e6e5e
  " Punctuation
  hi @punctuation.bracket   guifg=#5e6e5e
  hi @punctuation.delimiter guifg=#5e6e5e
  ...
  hi @text.strong           guifg=#5e6e5e gui=bold
  hi @text.emphasis         guifg=#5e6e5e gui=italic
endif
