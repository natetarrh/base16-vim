...
if has("nvim")
  ...
  hi @string.special.symbol guifg=#7b9726
  ...
  hi @function              guifg=#407ee7
  hi @function.builtin      guifg=#407ee7
  hi @function.call         guifg=#407ee7
  hi @function.macro        guifg=#f22c40
  hi @method                guifg=#407ee7
  hi @method.call           guifg=#407ee7
  hi @constructor           guifg=#407ee7
  " Variable / Parameter
  hi @parameter             guifg=#a8a19f
  hi @variable              guifg=#a8a19f
  hi @variable.builtin      guifg=#df5320
  hi @field                 guifg=#a8a19f
  hi @property              guifg=#a8a19f
  ...
  hi @tag.delimiter         guifg=#a8a19f
  " Punctuation
  hi @punctuation.bracket   guifg=#a8a19f
  hi @punctuation.delimiter guifg=#a8a19f
  hi @punctuation.special   guifg=#6666ea
  " Markup
  hi @text.literal          guifg=#7b9726
  hi @text.uri              guifg=#f22c40 gui=underline
  hi @text.reference        guifg=#407ee7
  hi @text.strong           guifg=#a8a19f gui=bold
  hi @text.emphasis         guifg=#a8a19f gui=italic
endif
