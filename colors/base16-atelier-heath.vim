...
if has("nvim")
  ...
  hi @string.special.symbol guifg=#516aec
  ...
  hi @function              guifg=#7b59c0
  hi @function.builtin      guifg=#7b59c0
  hi @function.call         guifg=#7b59c0
  hi @function.macro        guifg=#7b59c0
  hi @method                guifg=#7b59c0
  hi @method.call           guifg=#7b59c0
  hi @constructor           guifg=#7b59c0
  " Variable / Parameter
  hi @parameter             guifg=#ab9bab
  hi @variable              guifg=#ab9bab
  hi @variable.builtin      guifg=#a65926
  hi @field                 guifg=#ab9bab
  hi @property              guifg=#ab9bab
  ...
  hi @tag.delimiter         guifg=#ab9bab
  " Punctuation
  hi @punctuation.bracket   guifg=#ab9bab
  hi @punctuation.delimiter guifg=#ab9bab
  hi @punctuation.special   guifg=#ab9bab
  " Markup
  hi @text.literal          guifg=#918b3b
  hi @text.uri              guifg=#ca402b gui=underline
  hi @text.reference        guifg=#516aec
  hi @text.strong           guifg=#ab9bab gui=bold
  hi @text.emphasis         guifg=#ab9bab gui=italic
endif
