...
if has("nvim")
  ...
  hi @string.special.symbol guifg=#9b8d7f
  ...
  hi @type                  guifg=#8c7f70
  hi @type.builtin          guifg=#8c7f70
  hi @type.definition       guifg=#8c7f70
  hi @namespace             guifg=#8c7f70
  hi @symbol                guifg=#9b8d7f
  " Tag (HTML/XML)
  hi @tag                   guifg=#5f8787
  hi @tag.attribute         guifg=#8c7f70
