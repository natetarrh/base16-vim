...
let s:gui03        = "3f3f3f"
let g:base16_gui03 = "3f3f3f"
let s:gui04        = "666666"
let g:base16_gui04 = "666666"
let s:gui05        = "818181"
let g:base16_gui05 = "818181"
let s:gui06        = "c6c6c6"
let g:base16_gui06 = "c6c6c6"
let s:gui07        = "e9e9e9"
let g:base16_gui07 = "e9e9e9"
let s:gui08        = "ff29a8"
...
if has("nvim")
  ...
  hi @keyword               guifg=#00f6d9
  hi @keyword.function      guifg=#00f6d9
  hi @keyword.operator      guifg=#00f6d9
  hi @keyword.return        guifg=#00f6d9
  hi @conditional           guifg=#00f6d9
  hi @repeat                guifg=#f0ffaa
  hi @exception             guifg=#ff29a8
  hi @include               guifg=#00eaff
  " String — matches String (0B), SpecialChar (0F), Special (0C)
  hi @string                guifg=#0badff
  hi @string.escape         guifg=#8265ff
  hi @string.regex          guifg=#8265ff
  hi @string.regexp         guifg=#8265ff
  hi @string.special        guifg=#8265ff
  hi @string.special.symbol guifg=#0badff
  hi @character             guifg=#ff29a8
  " Constant / Number — matches Constant (09), Number (09), Boolean (09)
  hi @number                guifg=#85ffe0
  hi @boolean               guifg=#85ffe0
  hi @float                 guifg=#85ffe0
  hi @constant              guifg=#85ffe0
  hi @constant.builtin      guifg=#85ffe0
  hi @constant.macro        guifg=#ff29a8
  " Function / Method — matches Function (0D); calls same as definitions
  hi @function              guifg=#00eaff
  hi @function.builtin      guifg=#00eaff
  hi @function.call         guifg=#00eaff
  hi @function.macro        guifg=#ff29a8
  hi @method                guifg=#00eaff
  hi @method.call           guifg=#00eaff
  hi @constructor           guifg=#00eaff
  " Variable / Parameter
  hi @parameter             guifg=#818181
  hi @variable              guifg=#818181
  hi @variable.builtin      guifg=#85ffe0
  hi @field                 guifg=#818181
  hi @property              guifg=#818181
  " Type — matches Type (0A)
  hi @type                  guifg=#f0ffaa
  hi @type.builtin          guifg=#f0ffaa
  hi @type.definition       guifg=#f0ffaa
  hi @namespace             guifg=#f0ffaa
  hi @symbol                guifg=#0badff
  " Tag (HTML/XML)
  hi @tag                   guifg=#ff29a8
  hi @tag.attribute         guifg=#f0ffaa
  hi @tag.delimiter         guifg=#818181
  " Punctuation
  hi @punctuation.bracket   guifg=#818181
  hi @punctuation.delimiter guifg=#818181
  hi @punctuation.special   guifg=#00f6d9
  " Markup
  hi @text.literal          guifg=#0badff
  hi @text.uri              guifg=#ff29a8 gui=underline
  hi @text.reference        guifg=#00eaff
  hi @text.strong           guifg=#818181 gui=bold
  hi @text.emphasis         guifg=#818181 gui=italic
endif
