...
if has("nvim")
  " Comment
  hi @comment               guifg=#7d7a68 gui=italic
  ...
  " Variable / Parameter
  hi @parameter             guifg=#a6a28c
  hi @variable              guifg=#a6a28c
  hi @variable.builtin      guifg=#b65611
  hi @field                 guifg=#a6a28c
  hi @property              guifg=#a6a28c
  ...
  hi @tag.delimiter         guifg=#a6a28c
  " Punctuation
  hi @punctuation.bracket   guifg=#a6a28c
  hi @punctuation.delimiter guifg=#a6a28c
  ...
  hi @text.strong           guifg=#a6a28c gui=bold
  hi @text.emphasis         guifg=#a6a28c gui=italic
endif
