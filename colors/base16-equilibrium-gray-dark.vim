...
if has("nvim")
  ...
  " Variable / Parameter
  hi @parameter             guifg=#ababab
  hi @variable              guifg=#ababab
  hi @variable.builtin      guifg=#df5923
  hi @field                 guifg=#ababab
  hi @property              guifg=#ababab
  ...
  hi @tag.delimiter         guifg=#ababab
  " Punctuation
  hi @punctuation.bracket   guifg=#ababab
  hi @punctuation.delimiter guifg=#ababab
  hi @punctuation.special   guifg=#ababab
  " Markup
  hi @text.literal          guifg=#7f8b00
  hi @text.uri              guifg=#f04339 gui=underline
  hi @text.reference        guifg=#008dd1
  hi @text.strong           guifg=#ababab gui=bold
  hi @text.emphasis         guifg=#ababab gui=italic
endif
