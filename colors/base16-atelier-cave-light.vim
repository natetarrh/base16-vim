...
if has("nvim")
  " Comment
  hi @comment               guifg=#7e7887 gui=italic
  ...
  " Variable / Parameter
  hi @parameter             guifg=#585260
  hi @variable              guifg=#585260
  hi @variable.builtin      guifg=#aa573c
  hi @field                 guifg=#585260
  hi @property              guifg=#585260
  ...
  hi @tag.delimiter         guifg=#585260
  " Punctuation
  hi @punctuation.bracket   guifg=#585260
  hi @punctuation.delimiter guifg=#585260
  ...
  hi @text.strong           guifg=#585260 gui=bold
  hi @text.emphasis         guifg=#585260 gui=italic
endif
