...
if has("nvim")
  " Comment
  hi @comment               guifg=#878573 gui=italic
  " Keyword — matches Keyword (0E), Conditional (0E), Repeat (0A), Exception (08)
  hi @keyword               guifg=#ba6236
  hi @keyword.function      guifg=#ba6236
  hi @keyword.operator      guifg=#5f9182
  hi @keyword.return        guifg=#5f9182
  hi @conditional           guifg=#ba6236
  hi @repeat                guifg=#a5980d
  hi @exception             guifg=#ba6236
  hi @include               guifg=#36a166
  " String — matches String (0B), SpecialChar (0F), Special (0C)
  hi @string                guifg=#7d9726
  hi @string.escape         guifg=#5b9d48
  hi @string.regex          guifg=#5b9d48
  hi @string.regexp         guifg=#5b9d48
  hi @string.special        guifg=#5b9d48
  hi @string.special.symbol guifg=#36a166
  hi @character             guifg=#ba6236
  " Constant / Number — matches Constant (09), Number (09), Boolean (09)
  hi @number                guifg=#ae7313
  hi @boolean               guifg=#ae7313
  hi @float                 guifg=#ae7313
  hi @constant              guifg=#ae7313
  hi @constant.builtin      guifg=#ae7313
  hi @constant.macro        guifg=#ba6236
  " Function / Method — matches Function (0D); calls same as definitions
  hi @function              guifg=#5f9182
  hi @function.builtin      guifg=#5f9182
  hi @function.call         guifg=#5f9182
  hi @function.macro        guifg=#5f9182
  hi @method                guifg=#5f9182
  hi @method.call           guifg=#5f9182
  hi @constructor           guifg=#5f9182
  " Variable / Parameter
  hi @parameter             guifg=#5f5e4e
  hi @variable              guifg=#5f5e4e
  hi @variable.builtin      guifg=#ae7313
  hi @field                 guifg=#5f5e4e
  hi @property              guifg=#5f5e4e
  " Type — matches Type (0A)
  hi @type                  guifg=#a5980d
  hi @type.builtin          guifg=#a5980d
  hi @type.definition       guifg=#a5980d
  hi @namespace             guifg=#a5980d
  hi @symbol                guifg=#7d9726
  " Tag (HTML/XML)
  hi @tag                   guifg=#ba6236
  hi @tag.attribute         guifg=#a5980d
  hi @tag.delimiter         guifg=#5f5e4e
  " Punctuation
  hi @punctuation.bracket   guifg=#5f5e4e
  hi @punctuation.delimiter guifg=#5f5e4e
  hi @punctuation.special   guifg=#5f5e4e
  " Markup
  hi @text.literal          guifg=#7d9726
  hi @text.uri              guifg=#ba6236 gui=underline
  hi @text.reference        guifg=#36a166
  hi @text.strong           guifg=#5f5e4e gui=bold
  hi @text.emphasis         guifg=#5f5e4e gui=italic
endif
