...
if has("nvim")
  " Comment
  hi @comment               guifg=#7b776e gui=italic
  " Keyword — matches Keyword (0E), Conditional (0E), Repeat (0A), Exception (08)
  hi @keyword               guifg=#f04339
  hi @keyword.function      guifg=#f04339
  hi @keyword.operator      guifg=#6a7fd2
  hi @keyword.return        guifg=#6a7fd2
  hi @conditional           guifg=#f04339
  hi @repeat                guifg=#bb8801
  hi @exception             guifg=#f04339
  hi @include               guifg=#008dd1
  " String — matches String (0B), SpecialChar (0F), Special (0C)
  hi @string                guifg=#7f8b00
  hi @string.escape         guifg=#00948b
  hi @string.regex          guifg=#00948b
  hi @string.regexp         guifg=#00948b
  hi @string.special        guifg=#00948b
  hi @string.special.symbol guifg=#008dd1
  hi @character             guifg=#f04339
  " Constant / Number — matches Constant (09), Number (09), Boolean (09)
  hi @number                guifg=#df5923
  hi @boolean               guifg=#df5923
  hi @float                 guifg=#df5923
  hi @constant              guifg=#df5923
  hi @constant.builtin      guifg=#df5923
  hi @constant.macro        guifg=#f04339
  " Function / Method — matches Function (0D); calls same as definitions
  hi @function              guifg=#6a7fd2
  hi @function.builtin      guifg=#6a7fd2
  hi @function.call         guifg=#6a7fd2
  hi @function.macro        guifg=#6a7fd2
  hi @method                guifg=#6a7fd2
  hi @method.call           guifg=#6a7fd2
  hi @constructor           guifg=#6a7fd2
  " Variable / Parameter
  hi @parameter             guifg=#afaba2
  hi @variable              guifg=#afaba2
  hi @variable.builtin      guifg=#df5923
  hi @field                 guifg=#afaba2
  hi @property              guifg=#afaba2
  " Type — matches Type (0A)
  hi @type                  guifg=#bb8801
  hi @type.builtin          guifg=#bb8801
  hi @type.definition       guifg=#bb8801
  hi @namespace             guifg=#bb8801
  hi @symbol                guifg=#7f8b00
  " Tag (HTML/XML)
  hi @tag                   guifg=#f04339
  hi @tag.attribute         guifg=#bb8801
  hi @tag.delimiter         guifg=#afaba2
  " Punctuation
  hi @punctuation.bracket   guifg=#afaba2
  hi @punctuation.delimiter guifg=#afaba2
  hi @punctuation.special   guifg=#afaba2
  " Markup
  hi @text.literal          guifg=#7f8b00
  hi @text.uri              guifg=#f04339 gui=underline
  hi @text.reference        guifg=#008dd1
  hi @text.strong           guifg=#afaba2 gui=bold
  hi @text.emphasis         guifg=#afaba2 gui=italic
endif
