...
if has("nvim")
  " Comment
  hi @comment               guifg=#686A71 gui=italic
  " Keyword
  hi @keyword               guifg=#B21889
  hi @keyword.function      guifg=#B21889
  hi @keyword.operator      guifg=#B21889
  hi @keyword.return        guifg=#B21889
  hi @conditional           guifg=#B21889
  hi @repeat                guifg=#438288
  hi @exception             guifg=#B21889
  hi @include               guifg=#790EAD
  " String
  hi @string                guifg=#DF0002
  hi @string.escape         guifg=#00A0BE
  hi @string.regex          guifg=#00A0BE
  hi @string.special        guifg=#00A0BE
  hi @character             guifg=#B21889
  " Constant / Number
  hi @number                guifg=#786DC5
  hi @boolean               guifg=#786DC5
  hi @float                 guifg=#786DC5
  hi @constant              guifg=#786DC5
  ...
  hi @variable.builtin      guifg=#786DC5
  hi @field                 guifg=#939599
  hi @property              guifg=#939599
  " Type
  hi @type                  guifg=#438288
  hi @type.builtin          guifg=#438288
  hi @type.definition       guifg=#438288
  hi @namespace             guifg=#438288
  hi @symbol                guifg=#DF0002
  " Tag (HTML/XML)
  hi @tag                   guifg=#B21889
  hi @tag.attribute         guifg=#438288
  hi @tag.delimiter         guifg=#939599
  " Punctuation
  ...
  hi @text.reference        guifg=#790EAD
  hi @text.strong           guifg=#939599 gui=bold
  hi @text.emphasis         guifg=#939599 gui=italic
endif
