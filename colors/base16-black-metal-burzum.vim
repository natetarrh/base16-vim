...
if has("nvim")
  ...
  hi @string.special.symbol guifg=#ddeecc
  ...
  hi @type                  guifg=#99bbaa
  hi @type.builtin          guifg=#99bbaa
  hi @type.definition       guifg=#99bbaa
  hi @namespace             guifg=#99bbaa
  hi @symbol                guifg=#ddeecc
  " Tag (HTML/XML)
  hi @tag                   guifg=#5f8787
  hi @tag.attribute         guifg=#99bbaa
