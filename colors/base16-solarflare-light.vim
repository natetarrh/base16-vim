...
if has("nvim")
  " Comment
  hi @comment               guifg=#85939E gui=italic
  ...
  " Variable / Parameter
  hi @parameter             guifg=#586875
  hi @variable              guifg=#586875
  hi @variable.builtin      guifg=#E66B2B
  hi @field                 guifg=#586875
  hi @property              guifg=#586875
  ...
  hi @tag.delimiter         guifg=#586875
  " Punctuation
  hi @punctuation.bracket   guifg=#586875
  hi @punctuation.delimiter guifg=#586875
  hi @punctuation.special   guifg=#586875
  " Markup
  hi @text.literal          guifg=#7CC844
  hi @text.uri              guifg=#EF5253 gui=underline
  hi @text.reference        guifg=#33B5E1
  hi @text.strong           guifg=#586875 gui=bold
  hi @text.emphasis         guifg=#586875 gui=italic
endif
