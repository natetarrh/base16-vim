...
if has("nvim")
  " Comment
  hi @comment               guifg=#aabcce gui=italic
  ...
  " Variable / Parameter
  hi @parameter             guifg=#405c79
  hi @variable              guifg=#405c79
  hi @variable.builtin      guifg=#bfbf56
  hi @field                 guifg=#405c79
  hi @property              guifg=#405c79
  ...
  hi @tag.delimiter         guifg=#405c79
  " Punctuation
  hi @punctuation.bracket   guifg=#405c79
  hi @punctuation.delimiter guifg=#405c79
  hi @punctuation.special   guifg=#405c79
  " Markup
  hi @text.literal          guifg=#56bf8b
  hi @text.uri              guifg=#bf8b56 gui=underline
  hi @text.reference        guifg=#8b56bf
  hi @text.strong           guifg=#405c79 gui=bold
  hi @text.emphasis         guifg=#405c79 gui=italic
endif
