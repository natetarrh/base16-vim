...
if has("nvim")
  ...
  " Variable / Parameter
  hi @parameter             guifg=#474747
  hi @variable              guifg=#474747
  hi @variable.builtin      guifg=#bf3e05
  hi @field                 guifg=#474747
  hi @property              guifg=#474747
  ...
  hi @tag.delimiter         guifg=#474747
  " Punctuation
  hi @punctuation.bracket   guifg=#474747
  hi @punctuation.delimiter guifg=#474747
  ...
  hi @text.strong           guifg=#474747 gui=bold
  hi @text.emphasis         guifg=#474747 gui=italic
endif
