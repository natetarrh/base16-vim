...
if has("nvim")
  ...
  hi @keyword.function      guifg=#AC4142
  hi @keyword.operator      guifg=#AA759F
  hi @keyword.return        guifg=#AA759F
  hi @conditional           guifg=#AC4142
  hi @repeat                guifg=#F4BF75
  hi @exception             guifg=#AC4142
  hi @include               guifg=#6A9FB5
  " String — matches String (0B), SpecialChar (0F), Special (0C)
  hi @string                guifg=#90A959
  hi @string.escape         guifg=#75B5AA
  hi @string.regex          guifg=#75B5AA
  hi @string.regexp         guifg=#75B5AA
  hi @string.special        guifg=#75B5AA
  hi @string.special.symbol guifg=#6A9FB5
  hi @character             guifg=#AC4142
  " Constant / Number — matches Constant (09), Number (09), Boolean (09)
  hi @number                guifg=#D28445
  hi @boolean               guifg=#D28445
  hi @float                 guifg=#D28445
  hi @constant              guifg=#D28445
  hi @constant.builtin      guifg=#D28445
  hi @constant.macro        guifg=#AC4142
  " Function / Method — matches Function (0D); calls same as definitions
  hi @function              guifg=#AA759F
  hi @function.builtin      guifg=#AA759F
  hi @function.call         guifg=#AA759F
  hi @function.macro        guifg=#AA759F
  hi @method                guifg=#AA759F
  hi @method.call           guifg=#AA759F
  hi @constructor           guifg=#AA759F
  " Variable / Parameter
  hi @parameter             guifg=#303030
  hi @variable              guifg=#303030
  hi @variable.builtin      guifg=#D28445
  hi @field                 guifg=#303030
  hi @property              guifg=#303030
  " Type — matches Type (0A)
  hi @type                  guifg=#F4BF75
  hi @type.builtin          guifg=#F4BF75
  hi @type.definition       guifg=#F4BF75
  hi @namespace             guifg=#F4BF75
  hi @symbol                guifg=#90A959
  " Tag (HTML/XML)
  hi @tag                   guifg=#AC4142
  hi @tag.attribute         guifg=#F4BF75
  hi @tag.delimiter         guifg=#303030
  " Punctuation
  hi @punctuation.bracket   guifg=#303030
  hi @punctuation.delimiter guifg=#303030
  hi @punctuation.special   guifg=#303030
  " Markup
  hi @text.literal          guifg=#90A959
  hi @text.uri              guifg=#AC4142 gui=underline
  hi @text.reference        guifg=#6A9FB5
  hi @text.strong           guifg=#303030 gui=bold
  hi @text.emphasis         guifg=#303030 gui=italic
endif
