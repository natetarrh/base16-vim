...
if has("nvim")
  ...
  hi @keyword               guifg=#C594C5
  hi @keyword.function      guifg=#C594C5
  hi @keyword.operator      guifg=#C594C5
  hi @keyword.return        guifg=#C594C5
  hi @conditional           guifg=#C594C5
  hi @repeat                guifg=#FAC863
  hi @exception             guifg=#EC5f67
  hi @include               guifg=#6699CC
  " String — matches String (0B), SpecialChar (0F), Special (0C)
  hi @string                guifg=#99C794
  hi @string.escape         guifg=#5FB3B3
  hi @string.regex          guifg=#5FB3B3
  hi @string.regexp         guifg=#5FB3B3
  hi @string.special        guifg=#5FB3B3
  hi @string.special.symbol guifg=#99C794
  ...
  hi @field                 guifg=#C0C5CE
  hi @property              guifg=#C0C5CE
  " Type — matches Type (0A)
  hi @type                  guifg=#FAC863
  hi @type.builtin          guifg=#FAC863
  hi @type.definition       guifg=#FAC863
  hi @namespace             guifg=#FAC863
  hi @symbol                guifg=#99C794
  " Tag (HTML/XML)
  hi @tag                   guifg=#EC5f67
  hi @tag.attribute         guifg=#FAC863
  hi @tag.delimiter         guifg=#C0C5CE
  " Punctuation
  hi @punctuation.bracket   guifg=#C0C5CE
  hi @punctuation.delimiter guifg=#C0C5CE
  hi @punctuation.special   guifg=#C594C5
  " Markup
  hi @text.literal          guifg=#99C794
  hi @text.uri              guifg=#EC5f67 gui=underline
  hi @text.reference        guifg=#6699CC
  hi @text.strong           guifg=#C0C5CE gui=bold
  hi @text.emphasis         guifg=#C0C5CE gui=italic
endif
