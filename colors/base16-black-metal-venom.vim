...
if has("nvim")
  ...
  hi @string.special.symbol guifg=#f8f7f2
  ...
  hi @type                  guifg=#79241f
  hi @type.builtin          guifg=#79241f
  hi @type.definition       guifg=#79241f
  hi @namespace             guifg=#79241f
  hi @symbol                guifg=#f8f7f2
  " Tag (HTML/XML)
  hi @tag                   guifg=#5f8787
  hi @tag.attribute         guifg=#79241f
