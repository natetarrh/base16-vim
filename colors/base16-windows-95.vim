...
if has("nvim")
  " Comment
  hi @comment               guifg=#545454 gui=italic
  " Keyword — matches Keyword (0E), Conditional (0E), Repeat (0A), Exception (08)
  hi @keyword               guifg=#fc5454
  hi @keyword.function      guifg=#fc5454
  hi @keyword.operator      guifg=#fc54fc
  hi @keyword.return        guifg=#fc54fc
  hi @conditional           guifg=#fc5454
  hi @repeat                guifg=#fcfc54
  hi @exception             guifg=#fc5454
  hi @include               guifg=#5454fc
  " String — matches String (0B), SpecialChar (0F), Special (0C)
  hi @string                guifg=#54fc54
  hi @string.escape         guifg=#54fcfc
  hi @string.regex          guifg=#54fcfc
  hi @string.regexp         guifg=#54fcfc
  hi @string.special        guifg=#54fcfc
  hi @string.special.symbol guifg=#5454fc
  hi @character             guifg=#fc5454
  " Constant / Number — matches Constant (09), Number (09), Boolean (09)
  hi @number                guifg=#a85400
  hi @boolean               guifg=#a85400
  hi @float                 guifg=#a85400
  hi @constant              guifg=#a85400
  hi @constant.builtin      guifg=#a85400
  hi @constant.macro        guifg=#fc5454
  " Function / Method — matches Function (0D); calls same as definitions
  hi @function              guifg=#fc54fc
  hi @function.builtin      guifg=#fc54fc
  hi @function.call         guifg=#fc54fc
  hi @function.macro        guifg=#fc54fc
  hi @method                guifg=#fc54fc
  hi @method.call           guifg=#fc54fc
  hi @constructor           guifg=#fc54fc
  " Variable / Parameter
  hi @parameter             guifg=#a8a8a8
  hi @variable              guifg=#a8a8a8
  hi @variable.builtin      guifg=#a85400
  hi @field                 guifg=#a8a8a8
  hi @property              guifg=#a8a8a8
  " Type — matches Type (0A)
  hi @type                  guifg=#fcfc54
  hi @type.builtin          guifg=#fcfc54
  hi @type.definition       guifg=#fcfc54
  hi @namespace             guifg=#fcfc54
  hi @symbol                guifg=#54fc54
  " Tag (HTML/XML)
  hi @tag                   guifg=#fc5454
  hi @tag.attribute         guifg=#fcfc54
  hi @tag.delimiter         guifg=#a8a8a8
  " Punctuation
  hi @punctuation.bracket   guifg=#a8a8a8
  hi @punctuation.delimiter guifg=#a8a8a8
  hi @punctuation.special   guifg=#a8a8a8
  " Markup
  hi @text.literal          guifg=#54fc54
  hi @text.uri              guifg=#fc5454 gui=underline
  hi @text.reference        guifg=#5454fc
  hi @text.strong           guifg=#a8a8a8 gui=bold
  hi @text.emphasis         guifg=#a8a8a8 gui=italic
endif
