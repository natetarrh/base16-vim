...
if has("nvim")
  " Comment
  hi @comment               guifg=#898ea4 gui=italic
  ...
  " Variable / Parameter
  hi @parameter             guifg=#5e6687
  hi @variable              guifg=#5e6687
  hi @variable.builtin      guifg=#c76b29
  hi @field                 guifg=#5e6687
  hi @property              guifg=#5e6687
  ...
  hi @tag.delimiter         guifg=#5e6687
  " Punctuation
  hi @punctuation.bracket   guifg=#5e6687
  hi @punctuation.delimiter guifg=#5e6687
  hi @punctuation.special   guifg=#5e6687
  " Markup
  hi @text.literal          guifg=#ac9739
  hi @text.uri              guifg=#c94922 gui=underline
  hi @text.reference        guifg=#3d8fd1
  hi @text.strong           guifg=#5e6687 gui=bold
  hi @text.emphasis         guifg=#5e6687 gui=italic
endif
