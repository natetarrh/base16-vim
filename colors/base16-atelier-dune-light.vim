...
if has("nvim")
  " Comment
  hi @comment               guifg=#999580 gui=italic
  " Keyword — matches Keyword (0E), Conditional (0E), Repeat (0A), Exception (08)
  hi @keyword               guifg=#d73737
  hi @keyword.function      guifg=#d73737
  hi @keyword.operator      guifg=#b854d4
  hi @keyword.return        guifg=#b854d4
  hi @conditional           guifg=#d73737
  hi @repeat                guifg=#ae9513
  hi @exception             guifg=#d73737
  hi @include               guifg=#6684e1
  " String — matches String (0B), SpecialChar (0F), Special (0C)
  hi @string                guifg=#60ac39
  hi @string.escape         guifg=#1fad83
  hi @string.regex          guifg=#1fad83
  hi @string.regexp         guifg=#1fad83
  hi @string.special        guifg=#1fad83
  hi @string.special.symbol guifg=#6684e1
  hi @character             guifg=#d73737
  " Constant / Number — matches Constant (09), Number (09), Boolean (09)
  hi @number                guifg=#b65611
  hi @boolean               guifg=#b65611
  hi @float                 guifg=#b65611
  hi @constant              guifg=#b65611
  hi @constant.builtin      guifg=#b65611
  hi @constant.macro        guifg=#d73737
  " Function / Method — matches Function (0D); calls same as definitions
  hi @function              guifg=#b854d4
  hi @function.builtin      guifg=#b854d4
  hi @function.call         guifg=#b854d4
  hi @function.macro        guifg=#b854d4
  hi @method                guifg=#b854d4
  hi @method.call           guifg=#b854d4
  hi @constructor           guifg=#b854d4
  " Variable / Parameter
  hi @parameter             guifg=#6e6b5e
  hi @variable              guifg=#6e6b5e
  hi @variable.builtin      guifg=#b65611
  hi @field                 guifg=#6e6b5e
  hi @property              guifg=#6e6b5e
  " Type — matches Type (0A)
  hi @type                  guifg=#ae9513
  hi @type.builtin          guifg=#ae9513
  hi @type.definition       guifg=#ae9513
  hi @namespace             guifg=#ae9513
  hi @symbol                guifg=#60ac39
  " Tag (HTML/XML)
  hi @tag                   guifg=#d73737
  hi @tag.attribute         guifg=#ae9513
  hi @tag.delimiter         guifg=#6e6b5e
  " Punctuation
  hi @punctuation.bracket   guifg=#6e6b5e
  hi @punctuation.delimiter guifg=#6e6b5e
  hi @punctuation.special   guifg=#6e6b5e
  " Markup
  hi @text.literal          guifg=#60ac39
  hi @text.uri              guifg=#d73737 gui=underline
  hi @text.reference        guifg=#6684e1
  hi @text.strong           guifg=#6e6b5e gui=bold
  hi @text.emphasis         guifg=#6e6b5e gui=italic
endif
