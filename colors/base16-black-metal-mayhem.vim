...
if has("nvim")
  ...
  hi @string.special.symbol guifg=#f3ecd4
  ...
  hi @type                  guifg=#eecc6c
  hi @type.builtin          guifg=#eecc6c
  hi @type.definition       guifg=#eecc6c
  hi @namespace             guifg=#eecc6c
  hi @symbol                guifg=#f3ecd4
  " Tag (HTML/XML)
  hi @tag                   guifg=#5f8787
  hi @tag.attribute         guifg=#eecc6c
