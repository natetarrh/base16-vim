...
if has("nvim")
  ...
  hi @string                guifg=#977d7c
  hi @string.escape         guifg=#977d7c
  hi @string.regex          guifg=#977d7c
  hi @string.regexp         guifg=#977d7c
  hi @string.special        guifg=#977d7c
  hi @string.special.symbol guifg=#977d7c
  hi @character             guifg=#818591
  " Constant / Number — matches Constant (09), Number (09), Boolean (09)
  hi @number                guifg=#9198a3
  hi @boolean               guifg=#9198a3
  hi @float                 guifg=#9198a3
  hi @constant              guifg=#9198a3
  ...
  hi @variable.builtin      guifg=#9198a3
  hi @field                 guifg=#5b778c
  hi @property              guifg=#5b778c
  " Type — matches Type (0A)
  hi @type                  guifg=#adb4b9
  hi @type.builtin          guifg=#adb4b9
  hi @type.definition       guifg=#adb4b9
  hi @namespace             guifg=#adb4b9
  hi @symbol                guifg=#977d7c
  " Tag (HTML/XML)
  hi @tag                   guifg=#818591
  hi @tag.attribute         guifg=#adb4b9
  hi @tag.delimiter         guifg=#5b778c
  " Punctuation
  ...
  hi @text.reference        guifg=#977d7c
  hi @text.strong           guifg=#5b778c gui=bold
  hi @text.emphasis         guifg=#5b778c gui=italic
endif
