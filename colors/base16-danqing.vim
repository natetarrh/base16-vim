...
if has("nvim")
  " Comment
  hi @comment               guifg=#9da8a3 gui=italic
  ...
  " Variable / Parameter
  hi @parameter             guifg=#e0f0eF
  hi @variable              guifg=#e0f0eF
  hi @variable.builtin      guifg=#B38A61
  hi @field                 guifg=#e0f0eF
  hi @property              guifg=#e0f0eF
  ...
  hi @tag.delimiter         guifg=#e0f0eF
  " Punctuation
  hi @punctuation.bracket   guifg=#e0f0eF
  hi @punctuation.delimiter guifg=#e0f0eF
  hi @punctuation.special   guifg=#e0f0eF
  " Markup
  hi @text.literal          guifg=#8AB361
  hi @text.uri              guifg=#F9906F gui=underline
  hi @text.reference        guifg=#B0A4E3
  hi @text.strong           guifg=#e0f0eF gui=bold
  hi @text.emphasis         guifg=#e0f0eF gui=italic
endif
