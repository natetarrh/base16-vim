...
if has("nvim")
  " Comment
  hi @comment               guifg=#474849 gui=italic
  " Keyword — matches Keyword (0E), Conditional (0E), Repeat (0A), Exception (08)
  hi @keyword               guifg=#ea5ce2
  hi @keyword.function      guifg=#ea5ce2
  hi @keyword.operator      guifg=#ea5ce2
  hi @keyword.return        guifg=#ea5ce2
  hi @conditional           guifg=#ea5ce2
  hi @repeat                guifg=#c9d364
  hi @exception             guifg=#b53b50
  hi @include               guifg=#03aeff
  " String — matches String (0B), SpecialChar (0F), Special (0C)
  hi @string                guifg=#06ea61
  hi @string.escape         guifg=#42fff9
  hi @string.regex          guifg=#42fff9
  hi @string.regexp         guifg=#42fff9
  hi @string.special        guifg=#42fff9
  hi @string.special.symbol guifg=#06ea61
  hi @character             guifg=#b53b50
  " Constant / Number — matches Constant (09), Number (09), Boolean (09)
  hi @number                guifg=#ea770d
  hi @boolean               guifg=#ea770d
  hi @float                 guifg=#ea770d
  hi @constant              guifg=#ea770d
  hi @constant.builtin      guifg=#ea770d
  hi @constant.macro        guifg=#b53b50
  " Function / Method — matches Function (0D); calls same as definitions
  hi @function              guifg=#03aeff
  hi @function.builtin      guifg=#03aeff
  hi @function.call         guifg=#03aeff
  hi @function.macro        guifg=#b53b50
  hi @method                guifg=#03aeff
  hi @method.call           guifg=#03aeff
  hi @constructor           guifg=#03aeff
  " Variable / Parameter
  hi @parameter             guifg=#c1c3c4
  hi @variable              guifg=#c1c3c4
  hi @variable.builtin      guifg=#ea770d
  hi @field                 guifg=#c1c3c4
  hi @property              guifg=#c1c3c4
  " Type — matches Type (0A)
  hi @type                  guifg=#c9d364
  hi @type.builtin          guifg=#c9d364
  hi @type.definition       guifg=#c9d364
  hi @namespace             guifg=#c9d364
  hi @symbol                guifg=#06ea61
  " Tag (HTML/XML)
  hi @tag                   guifg=#b53b50
  hi @tag.attribute         guifg=#c9d364
  hi @tag.delimiter         guifg=#c1c3c4
  " Punctuation
  hi @punctuation.bracket   guifg=#c1c3c4
  hi @punctuation.delimiter guifg=#c1c3c4
  hi @punctuation.special   guifg=#ea5ce2
  " Markup
  hi @text.literal          guifg=#06ea61
  hi @text.uri              guifg=#b53b50 gui=underline
  hi @text.reference        guifg=#03aeff
  hi @text.strong           guifg=#c1c3c4 gui=bold
  hi @text.emphasis         guifg=#c1c3c4 gui=italic
endif
