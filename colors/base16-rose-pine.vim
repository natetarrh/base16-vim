...
if has("nvim")
  ...
  hi @string.special.symbol guifg=#31748f
  ...
  hi @type                  guifg=#ebbcba
  hi @type.builtin          guifg=#ebbcba
  hi @type.definition       guifg=#ebbcba
  hi @namespace             guifg=#ebbcba
  hi @symbol                guifg=#31748f
  " Tag (HTML/XML)
  hi @tag                   guifg=#eb6f92
  hi @tag.attribute         guifg=#ebbcba
